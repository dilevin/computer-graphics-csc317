...
| Week | Topic / Event |
| ---- | :------------ |
| 1    | Introduction, [Assignment 1 (Raster Images)](https://github.com/dilevin/computer-graphics-raster-images/tree/master) **waitlisted ? zip assignment and email to TAs** due 20/09
